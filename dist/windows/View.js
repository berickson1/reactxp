...
var View = /** @class */ (function (_super) {
    ...
    View.prototype._buildInternalProps = function (props) {
        ...
        var hasGroup = this.hasTrait(Interfaces_1.Types.AccessibilityTrait.Group, props.accessibilityTraits);
        var hasDialog = this.hasTrait(Interfaces_1.Types.AccessibilityTrait.Dialog, props.accessibilityTraits);
...
function isKeyboardFocusable(tabIndex) {
